...
// Using spark.ml for data frames
...
object LinearRegressionDataFrame {
  ...
  def main(args: Array[String]) {
    ...
    // Use SparkSession since now we are dealing with data frames
    ...
    // In machine learning in Spark, "label" is just the value you're trying to predict, and
    // "point" is the feature you are given to make a prediction with. So in this example
    // the "labels" are the first column of our data, and "points" are the second column.
