...
object DegreesOfSeparation {
  ...
  val startCharacterID = 2066 // "Murray Garfield"
  val targetCharacterID = 3045 // "Joseph"
  // Note, Spiderman is 5306; and Spiderman is 1 or 2 degrees of separation
  // from almost everyone.  Note, some of the higher number characters are not 
  // connected to anyone (they are really obscure and/or were not included in the graph).
  // Captain America is 859
  ...
  def createStartingRdd(sc:SparkContext): RDD[BFSNode] = {
    val inputFile = sc.textFile("../MarvelGraph.txt")
