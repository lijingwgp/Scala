...
object DataFrames {
  ...
  def main(args: Array[String]) {
    ...
    // Use .cache() if the data set is used more than once
    ...
    // The following code shows ways of operating on a data set directly
    // using Scala Spark syntax, instead of using SQL calls
